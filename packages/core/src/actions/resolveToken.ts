...
export const resolveToken: Action = {
        ...
        [
            {
                ...
                output: {
                    ...
                    message: "Resolved token address: 0xA0b86991c6218b36c1d19D4a2e9EB0CE3606EB48",
                },
    ...
    handler: async (agent, input) => {
        try {
            ...
            let tokenAddress = getResolvedTokenAddress({ token: input.token, chainId: agent.config.chainId, tokens })
            return {
                status: "success",
                tokenAddress,
